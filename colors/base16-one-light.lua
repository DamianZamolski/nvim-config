...
vim.api.nvim_set_hl(0, 'Operator', { fg = gui07, ctermfg = cterm05 })
...
-- CSS highlighting
vim.api.nvim_set_hl(0, 'cssBraces', { fg = gui07, ctermfg = cterm05 })
...
vim.api.nvim_set_hl(0, 'htmlEndTag', { fg = gui07, ctermfg = cterm05 })
vim.api.nvim_set_hl(0, 'htmlTag', { fg = gui07, ctermfg = cterm05 })

-- JavaScript highlighting
vim.api.nvim_set_hl(0, 'javaScript', { fg = gui07, ctermfg = cterm05 })
vim.api.nvim_set_hl(0, 'javaScriptBraces', { fg = gui07, ctermfg = cterm05 })
...
vim.api.nvim_set_hl(0, 'LspDiagnosticsDefaultHnformation', { fg = gui07, ctermfg = cterm05 })
...
vim.api.nvim_set_hl(0, 'markdownError', { fg = gui07, bg = gui00, ctermfg = cterm05, ctermbg = cterm00 })
...
vim.api.nvim_set_hl(0, 'NERDTreeExecFile', { fg = gui07, ctermfg = cterm05 })

-- PHP highlighting
vim.api.nvim_set_hl(0, 'phpMemberSelector', { fg = gui07, ctermfg = cterm05 })
vim.api.nvim_set_hl(0, 'phpComparison', { fg = gui07, ctermfg = cterm05 })
vim.api.nvim_set_hl(0, 'phpParent', { fg = gui07, ctermfg = cterm05 })
